...
vlog -work xpm  -incr "+incdir+../../../ipstatic" "+incdir+../../../../RISCV_CPU.gen/sources_1/ip/clk_pll" -l xpm -l xil_defaultlib \
...
vlog -work xil_defaultlib  -incr -v2k5 "+incdir+../../../ipstatic" "+incdir+../../../../RISCV_CPU.gen/sources_1/ip/clk_pll" -l xpm -l xil_defaultlib \
