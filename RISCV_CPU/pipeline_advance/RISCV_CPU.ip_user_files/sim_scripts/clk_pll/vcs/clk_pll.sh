...
#
# Script generated by Vivado on Tue Apr 29 15:41:21 +0800 2025
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../../RISCV_CPU.gen/sources_1/ip/clk_pll" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../../RISCV_CPU.gen/sources_1/ip/clk_pll" \
