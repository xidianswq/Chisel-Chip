...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../../RISCV_CPU.gen/sources_1/ip/clk_pll" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../../RISCV_CPU.gen/sources_1/ip/clk_pll" \
