...
#
# Script generated by Vivado on Tue Apr 22 17:35:49 +0800 2025
...
#
# Usage        : mem.sh
#                mem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mem.sh [-reset_run]
#                mem.sh [-reset_log]
#                mem.sh [-help]
#
...
# script info
echo -e "mem.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mem xil_defaultlib.mem xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/software/work/xilinx/Vivado/2023.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mem.wdb xsim.dir libdpi.so)
...
Usage: mem.sh [-reset_log]\n\
Usage: mem.sh [-keep_index]\n\
