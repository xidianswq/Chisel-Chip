...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [31:0] reg_csr [0:4095]; // @[Core.scala 19:22]
  wire [31:0] reg_csr_reg_pc_next_MPORT_data; // @[Core.scala 19:22]
  wire [11:0] reg_csr_reg_pc_next_MPORT_addr; // @[Core.scala 19:22]
  wire [31:0] reg_csr_csr_rdata_data; // @[Core.scala 19:22]
  wire [11:0] reg_csr_csr_rdata_addr; // @[Core.scala 19:22]
  wire [31:0] reg_csr_MPORT_data; // @[Core.scala 19:22]
  wire [11:0] reg_csr_MPORT_addr; // @[Core.scala 19:22]
  ...
  wire  _T_3 = ~reset; // @[Core.scala 195:11]
