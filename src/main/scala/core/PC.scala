...
class PC_BUBBLE_REG extends Module{
    ...
    val stall_flag      = io.stall_io.stall_flag
    val pred_miss_flag  = io.stall_io.pred_miss_flag
...
class PC extends Module{
    ...
    val trap_vector     = io.in.ex_io.csr_io.trap_vector
    val pred_flag       = io.in.bp_io.pred_flag
    val pred_target     = io.in.bp_io.pred_target
