...
class Stall extends Module{
    ...
    val br_flag         = io.in.if_in.ex_io.br_io.br_flag
    val br_target       = io.in.if_in.ex_io.br_io.br_target
    val jump_flag       = io.in.if_in.ex_io.alu_io.jump_flag
    val jump_target     = io.in.if_in.ex_io.alu_io.alu_out
